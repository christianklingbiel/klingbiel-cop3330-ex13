...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println("What is the principal amount? "); double principal = in.nextDouble();
        System.out.println("What is the rate? "); double rate = in.nextDouble();
        System.out.println("What is  the number of years? "); double years = in.nextDouble();
        System.out.println("What is the number of times the interest  is compounded per year? "); double compounded = in.nextDouble();
        System.out.println("$" + principal + " invested at " + rate + "% for " + years + " years compounded " + compounded + " times per year is $" +  (principal * Math.pow((1 + ((rate / 100) / compounded)),(compounded * years))));
    }
}
